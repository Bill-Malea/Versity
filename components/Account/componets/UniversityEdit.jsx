        ...
        <div>
          ...
          {departments.map((dept, index) => (
            <div key={index}>
              ...
              <button
                type="button"
                className={`relative  text-sm transition duration-300 text-green-400 bg-black   rounded-md px-7 py-2 mt-5`}
      ...
      <ul>
        {universities.map((university) => (
          <li key={university.id}>
            ...
            <div className="mt-5">
              Departments:{" "}
              {university.departments && university.departments.join(", ")}
            </div>
          </li>
        ))}
      </ul>
